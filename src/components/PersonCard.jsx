...
function PersonCard() {
    return (
        <div className="flex desktop:flex-row flex-col p-4 desktop:w-[500px] w-[45%] h-fit desktop:h-[200px] bg-secondryBg shadow-md drop-shadow-md desktop:justify-between items-center desktop:items-start rounded-md ">
