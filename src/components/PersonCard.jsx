...
function PersonCard(props) {
    return (
        <div className={`flex desktop:flex-row flex-col p-4 ${props.main ? "desktop:w-[1032px] w-[90%] max-w-[90%] desktop:items-center desktop:justify-center items-center justify-center" : "desktop:w-[500px] w-[45%] desktop:justify-between desktop:items-center items-center  "} desktop:h-[200px] h-fit  bg-secondryBg shadow-md drop-shadow-lg rounded-2xl  `}>

            <div className={`flex desktop:flex-col  flex-col items-center justify-center desktop:text-xl text-base text-center ${props.main ? "desktop:mr-8" : ""}`} >
