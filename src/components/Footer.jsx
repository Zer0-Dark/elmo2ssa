    ...
    return (
        <div id="contact" className=" bg-mainTheme">
            ...
            <div className="  flex flex-row p-8 gap-2 desktop:space-y-0 space-y-10  ">
                ...
                <div className="desktop:w-1/3 flex flex-col desktop:items-end items-end w-1/3">
                    <img src={logo} alt="logo" className="desktop:max-w-32 desktop:mr-10 mb-2 max-w-14"></img>
                    <h1 dir="rtl" lang="ar" className=" text-white font-mainFont desktop:text-xl text-xs">مؤسسة محمود فهمي درويش</h1>
                </div>
            </div>
