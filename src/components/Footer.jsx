        ...
        <div className=" bg-mainTheme">
            ...
            <div className="flex  p-8 ">
                ...
                <div className="w-1/3 flex flex-col items-end">
                    <img src={logo} alt="logo" className="max-w-32 mr-10 mb-2"></img>
            ...
            <div>
                <div></div>
                <div className="flex justify-between text-white text-xl font-mainFont px-8 py-4  border-t-2 border-white ">
